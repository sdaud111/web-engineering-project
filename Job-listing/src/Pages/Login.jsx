...
const LeftSidebar = () => {
    ...
    return (
        <div className="w-full md:w-1/2 h-[100vh] flex justify-center items-center p-4 md:p-0">
            <section className="w-full sm:w-[80%] md:w-[30vw] h-[60vh] font-[Nunito] bg-white rounded-lg text-indigo-900 flex flex-col gap-10 md:gap-32 justify-center items-center">
                <div className="flex flex-col">
                    <h2 className="relative text-3xl sm:text-4xl md:text-5xl font-bold">login</h2>
                    <span className="block w-12 sm:w-14 md:w-16 h-1 sm:h-2 bg-indigo-900 mx-auto mt-3"></span>
                </div>
                <div className="flex flex-col justify-center items-center gap-6 md:gap-12 w-full px-4 md:px-18 text-black">
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-8 font-bold w-full justify-between">
                        <button
                            onClick={handleLogin}
                            className="cursor-pointer bg-indigo-700 text-white px-8 py-3 sm:py-4 rounded-4xl w-full sm:w-1/2"
                        >
                            login
                        </button>
...
const RightSidebar = () => {
    return (
        <div className="hidden md:flex w-1/2 h-[100vh] rounded-r-3xl bg-[url('src/assets/dots.jpg')] text-right">
            <div className="flex flex-col gap-12 h-[100vh] w-full bg-indigo-900 opacity-90 rounded-l-3xl justify-center items-end px-12">
                <h1 className="text-white text-4xl sm:text-5xl md:text-6xl font-extrabold w-[90%] leading-snug tracking-wide">
                    Welcome back to JobConnect! It's been a while...
                </h1>
                <p className="text-gray-300 text-lg sm:text-xl md:text-2xl w-[60%] leading-snug tracking-wide">
